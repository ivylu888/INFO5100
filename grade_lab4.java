...
public class grade {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("How many exams do you want to enter?");

    Scanner sc =  new Scanner(System.in);
    int num = sc.nextInt();
    double[] allPoint = new double [num];
    double[] allWeightd = new double [num];
    double[] allEarnedPoints = new double [num];
